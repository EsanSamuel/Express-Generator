...
const controller_files_1 = require("./helpers/generators/controller-files");
...
async function main() {
    ...
    if (!fs_1.default.existsSync(projectPath)) {
        ...
        console.log(chalk_1.default.blue(`📁 Created project: ${answers.name}`));
    }
    ...
    folders.forEach((folder) => {
        ...
        if (folder === "controllers") {
            ...
            fs_1.default.writeFileSync(filePath, controller_files_1.userControllerFile);
        }
        if (folder === "routes") {
            const filePath = path_1.default.join(folderPath, "user.route.ts");
            fs_1.default.writeFileSync(filePath, controller_files_1.userRouteFiles);
        }
    });
